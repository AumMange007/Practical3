      ...
      <Container maxWidth="lg">
        ...
        <div className="text-center mb-20 flex flex-col items-center">
          ...
          <Typography className="text-gray-500 text-lg max-w-xl leading-relaxed">
            ...
            special requests — our hospitality team is always ready to assist
            you.
          </Typography>
        </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="bg-white shadow-md rounded-2xl p-8 flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">support@tajhotels.com</p>
              </div>
            </div>
          </div>
          {/* ===== Map Section ===== */}
